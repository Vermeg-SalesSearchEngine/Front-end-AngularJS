 ...
 */
 function responseRenderer(instance, td, row, col, prop, value, cellProperties) {
  Handsontable.renderers.TextRenderer.apply(this, arguments);
  td.style.fontWeight = 'bold';
  td.style.color = 'black';
  td.style.background = '#CEC';
}
Handsontable.renderers.registerRenderer('responseRenderer', responseRenderer);
function questionRenderer(instance, td, row, col, prop, value, cellProperties) {
  Handsontable.renderers.TextRenderer.apply(this, arguments);
  td.style.fontWeight = 'bold';
  td.style.color = 'black';
  td.style.background = '#FF6666';
}
Handsontable.renderers.registerRenderer('questionRenderer', questionRenderer);
